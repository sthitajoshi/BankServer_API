...
func (s *APIServer) run() {
	...
	router.HandleFunc("/transfer", makeHTTPHandleFunc(s.handleTrasfer))

	log.Println("JSON API server running on port :localhost:8080", s.listenAddr)
